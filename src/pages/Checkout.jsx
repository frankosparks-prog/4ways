  ...
  return (
    <div className="max-w-6xl mx-auto mt-16 p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <section className="lg:col-span-2 space-y-6">
        ...
        <div className="block lg:hidden mt-6 border-t pt-4 text-right font-semibold text-amber-800 text-xl">
      ...
      <aside className="bg-white rounded-xl shadow-md p-6 sticky top-28 h-fit space-y-8">
        ...
        <div className="border-t pt-6 text-xl font-extrabold text-amber-900 flex justify-between">
          <span>Subtotal</span>
...
//       <h2 className="text-3xl font-bold mb-6 text-amber-800 text-center">
//         🛒 Checkout
//       </h2>
...
//           {/* Instructions */}
//           <div className="mb-8 text-gray-600 text-sm bg-amber-50 p-4 rounded-md border border-amber-100">
...
//               disabled={isPaying}
//               className="bg-amber-700 text-white px-8 py-3 rounded hover:bg-amber-800 disabled:opacity-50"
//             >
