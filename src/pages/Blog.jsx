...
//         <h1 className="text-4xl font-bold text-amber-900 mb-4">Beadworks Blog</h1>
...
//         {blogPosts.map((post) => (
//           <div key={post.id} className="border rounded-xl shadow-sm hover:shadow-lg transition p-6 bg-amber-50">
//             <h3 className="text-xl font-semibold text-amber-900 mb-2">{post.title}</h3>
...
//             <a href={post.link} className="text-amber-700 font-medium hover:underline">Read more →</a>
//           </div>
//         ))}
//       </section>
//     </div>
