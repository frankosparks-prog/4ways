...
//   return (
//     <div className="min-h-screen bg-white text-amber-900 mt-4">
//       {/* Hero */}
//       <div className="bg-amber-100 py-12 px-6 text-center">
//         <h1 className="text-4xl font-bold mb-4">How Beadwork Became a Global Fashion Statement</h1>
//         <div className="flex justify-center items-center text-sm text-amber-700">
...
//         <button
//           onClick={() => navigate(-1)}
//           className="flex items-center text-sm text-amber-700 hover:underline mb-4"
//         >
...
//       {/* Blog Content */}
//       <article className="max-w-4xl mx-auto px-4 pb-20 leading-relaxed text-lg text-amber-800">
//         <p className="mb-6">
