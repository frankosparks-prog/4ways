    ...
    <>
      <footer className="bg-zinc-900 text-gray-200 px-6 py-12 mt-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-sm">
          ...
          {/* Branding */}
          <div>
            <h3 className="text-2xl font-bold text-white mb-3">Johnsaga Fashions</h3>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              ...
              <a href="mailto:info@johnsagafashions.com" className="hover:text-white">
                <Mail size={20} />
              </a>
            </div>
            <p className="text-gray-400 flex items-center gap-1"><Mail size={14} /> info@johnsagafashions.com</p>
        ...
        <div className="border-t border-gray-700 mt-10 pt-5 text-center text-gray-500 text-xs">
          &copy; {new Date().getFullYear()} Johnsaga Fashions. All rights reserved.
        </div>
      </footer>
